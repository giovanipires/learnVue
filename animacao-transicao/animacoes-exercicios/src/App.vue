<template>
	<div id="app" class="container-fluid">
		...
		<hr>
		<b-button variant="secondary" class="mb-4" @click="exibir2 = !exibir2">Alternar</b-button>
		<transition
		:css="false"
		...
		<hr>
		<div class="mb-4">
			<b-button variant="info" class="mr-2" @click="componenteSelecionado = 'AlertaInfo'">Info</b-button>
			<b-button variant="warning" class="mr-2" @click="componenteSelecionado = 'AlertaAdvertencia'">Advertência</b-button>
		</div>
...
export default {
	...
	data() {
		return {
			alunos: ['Giovani', 'Marianna', 'Lena', 'Anibal'],
			msg: 'Uma mensagem de informaçã para o usuário!',
			exibir: false,
			exibir2: true,
			tipoAnimacao: 'fade',
			larguraBase: 0,
	...
	methods: {
		...
		beforeEnter(el) {this.larguraBase = 0
