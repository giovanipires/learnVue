<template>
  <div>
    ...
    <v-sheet :elevation="6" class="pa-2 primary" >
      ...
      <span class="headline white--text font-wight-light">Você pode Salvar & Carregar os dados.</span>
    </v-sheet>
    <v-sheet :elevation="6" class="pa-2 success darken-1 mt-3" >
      <v-icon class="white--text mr-3">info</v-icon>
      <span class="headline white--text font-wight-light">Clique em 'Finalizar Dia' para iniciar um novo dia.</span>
    </v-sheet>
